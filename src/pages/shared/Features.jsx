      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="md:w-2/3 lg:w-1/2">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            SmritiCert revolutionizes how institutions issue and individuals manage verifiable credentials. Our secure, blockchain-backed system ensures authenticity, transparency, and accessibility of digital certificates.
          </p>
        </div>
          ...
          {[
            {
              ...
              description: 'All certificates are immutable and verifiable via blockchain technology, ensuring trust and transparency.',
              img: 'https://cdn-icons-png.flaticon.com/512/4341/4341139.png'
            },
            {
              title: 'One-Click Sharing',
              description: 'Easily share your credentials with employers or institutions through secure, unique links.',
              img: 'https://cdn-icons-png.flaticon.com/512/4341/4341134.png'
            },
            {
              title: 'Multi-Institute Support',
              description: 'SmritiCert supports credential issuance from schools, universities, and certification bodies.',
              img: 'https://cdn-icons-png.flaticon.com/512/4341/4341160.png'
            },
            {
              title: 'Tamper-Proof Records',
              description: 'Every certificate issued is cryptographically secured, making it tamper-resistant and fraud-proof.',
